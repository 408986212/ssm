...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#dg").datagrid({
			idField:"id",
			url:"userinformation/queryByPage",
	...
	function remove(){
		...
		$.messager.confirm("提示","你确定要删除这"+array.length+"条记录吗？",function(r){
			if(r){
				...
				$.ajax({
					url:"userinformation/deleteMore?ids="+ids,
					type:"post",
	...
	function update(){
        ...
        $("#ff").form("reset");
      	//修改记录的请求地址
		url = "userinformation/update?id="+array[0].id;
		//表单填充内容
		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					...
					<td><input type="date" name="birthday" class="easyui-textbox" data-options="required:true"></td>
				</tr>
